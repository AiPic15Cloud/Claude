...
export const DISCLAIMER =
  ...
  "cet indicateur est un outil d'aide à la décision interne, et toute décision d'engagement ou de recouvrement reste de la " +
  'responsabilité du comité/analyste habilité.';
