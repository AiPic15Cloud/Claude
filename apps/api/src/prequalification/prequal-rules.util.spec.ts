...
function result(overrides: Partial<PrequalFinancialResult> = {}): PrequalFinancialResult {
  return {
    ...
    financing: {
      collecte: 40_000_000,
      tauxPct: null,
      tauxPctEffectif: null,
      latePenaltyEffective: false,
      dureeCibleMonths: null,
      interestOnDurationCible: 0,
      feesHT: 0,
      feesTTC: 0,
      guaranteeFeesEstimate: 0,
      totalFees: 0,
      netDisbursed: 40_000_000,
    },
    bank: { enabled: false, name: null, loanTotal: 0, interestOnDurationCible: 0, totalFees: 0 },
    expositionFinale: 0,
    ltaPct: null,
    ltcPct: null,
    ltvPct: null,
    ltaAvecBanquePct: null,
    ltcAvecBanquePct: null,
    ltvAvecBanquePct: null,
    sensitivity: [],
    ...overrides,
  };
}
