...
export function AtlasMark({ className }: { className?: string }) {
  return (
    // Explicit width/height give a sane 24x24 fallback if the stylesheet
    // ever fails to load — without them an unconstrained <svg> has no
    // intrinsic size and can stretch to fill its container.
    <svg width="24" height="24" viewBox="0 0 240 240" className={className} aria-hidden="true">
